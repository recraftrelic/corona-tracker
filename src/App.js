  ...
  return (
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="six columns"><h5>{globalData.total_active_cases}</h5></div>
      </div>
      <div class="row">
        <div class="six columns"><h5>Total Deaths</h5></div>
        <div class="six columns"><h5>{globalData.total_deaths}</h5></div>
      </div>
      <div class="row">
        <div class="six columns"><h5>New Cases Today</h5></div>
        <div class="six columns"><h5>{globalData.total_new_cases_today}</h5></div>
      </div>
      <div class="row">
        <div class="six columns"><h5>New Deaths Today</h5></div>
        <div class="six columns"><h5>{globalData.total_new_deaths_today}</h5></div>
      </div>
      <div class="row">
        <div class="six columns"><h5>Total Recovered Cases</h5></div>
        <div class="six columns"><h5>{globalData.total_recovered}</h5></div>
      </div>
    </div>
  );
}
